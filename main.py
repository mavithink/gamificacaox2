...
if pagina == "Painel Principal":
    ...
    with st.container(border=True):
        ...
        st.markdown(f"""
            <table width="100%" border="1" cellpadding="5" cellspacing="0" bordercolor="#6e0b8a" style="margin-bottom: 15px; text-align: center; background-color: #FFFFFF; font-family: 'VT323', monospace;">
